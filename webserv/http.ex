defmodule HTTP do
    ...
    def http_version( [?H, ?T, ?T, ?P, ?/, ?1, ?., ?1 | r0] ), do: {:v11, r0}
    def http_version( [?H, ?T, ?T, ?P, ?/, ?1, ?., ?0 | r0] ), do: {:v10, r0}
...
IO.puts inspect( HTTP.parse_request( 'GET /index.html HTTP/1.1\r\nfoo 34\r\n\r\nHello' ) )
